...
import org.leeon.pattern.factory.method.Keyboard.ThemeType;

public class SymbolKeyboardFactory extends KeyboardFactory{
	...
	public Keyboard createKeyboard(Keyboard.ThemeType theme) {
		...
		System.out.println("Making a Symbol Keyboard with a new theme");
